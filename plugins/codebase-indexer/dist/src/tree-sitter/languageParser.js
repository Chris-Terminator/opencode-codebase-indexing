...
function uniquePaths(paths) {
    return [...new Set(paths.filter((item) => !!item))];
}
...
function resolveFromDirectories(file, dirs) {
...
export function resolveCoreRuntimeWasmPath(sourceDirectory) {
...
export function resolveLanguageWasmPath(langName, sourceDirectory) {
    const dirs = wasmDirectories(sourceDirectory);
