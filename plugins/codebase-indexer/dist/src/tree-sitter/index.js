...
function shouldSkipMinLines(lineCount, capture, _language) {
...
export { extensions };
export async function parseSourceCodeDefinitionsForFile(filePath) {
    try {
    ...
    try {
        ...
        const isUnsupported = msg.startsWith("Unsupported language:") || msg.startsWith("Missing tree-sitter language WASM:");
        if (!isUnsupported) {
            throw error;
        }
