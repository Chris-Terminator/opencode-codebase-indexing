import { MAX_BATCH_TOKENS, MAX_ITEM_TOKENS, MAX_BATCH_RETRIES as MAX_RETRIES, INITIAL_RETRY_DELAY_MS as INITIAL_DELAY_MS, REMOTE_EMBEDDER_VALIDATION_TIMEOUT_MS, } from "../constants";
...
export class VoyageEmbedder {
    static VOYAGE_BASE_URL = "https://api.voyageai.com/v1/embeddings";
    static DEFAULT_MODEL = "voyage-code-3";
    apiKey;
    modelId;
    /**
