...
import { MAX_BATCH_TOKENS, MAX_ITEM_TOKENS, MAX_BATCH_RETRIES as MAX_RETRIES, INITIAL_RETRY_DELAY_MS as INITIAL_DELAY_MS, REMOTE_EMBEDDER_VALIDATION_MAX_RETRIES, REMOTE_EMBEDDER_VALIDATION_TIMEOUT_MS, } from "../constants";
...
export class OpenRouterEmbedder {
     ...
     */
    constructor(apiKey, modelId, maxItemTokens, specificProvider, dimensions) {
        if (!apiKey) {
        ...
        for (let attempts = 0; attempts < MAX_RETRIES; attempts++) {
            ...
            try {
                ...
                if (!response.data || response.data.length === 0) {
                    ...
                    const invalid = new Error(msg ?? "Invalid response from OpenRouter embedding endpoint");
